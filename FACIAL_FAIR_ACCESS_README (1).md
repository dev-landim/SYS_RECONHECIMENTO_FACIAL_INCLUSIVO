...
<!-- 💡 DICA: substitua o caminho abaixo por uma foto/GIF real do projeto funcionando -->
<!-- Exemplo: ![Demo](./assets/demo.gif) -->
<!-- Para converter vídeo em GIF: https://ezgif.com/video-to-gif -->

> ⬆️ *Adicione aqui um GIF ou imagem do sistema funcionando (ex: `![Demo](./assets/demo.gif)`)*
...
<!-- 💡 DICA: adicione suas fotos da apresentação aqui -->
<!-- Exemplo:
<p align="center">
  <img src="./assets/foto1.jpg" width="45%" />
  <img src="./assets/foto2.jpg" width="45%" />
</p>
-->

> ⬆️ *Adicione aqui fotos da apresentação e do sistema em funcionamento*
